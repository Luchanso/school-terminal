...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("Loutchansky Oleg", "school-terminal", "com.luchanso.schoolterminal.school-terminal", "1.0.0");
		...
		flash.Lib.create (function () {
				...
				for (methodName in Type.getClassFields (com.luchanso.schoolterminal.Main)) {
				...
				if (hasMain) {
					...
					Reflect.callMethod (com.luchanso.schoolterminal.Main, Reflect.field (com.luchanso.schoolterminal.Main, "main"), []);
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			if (hasMain) {
				...
				var instance = Type.createInstance (com.luchanso.schoolterminal.Main, []);
			}
...
import com.luchanso.schoolterminal.Main;
